...
const requiredKeys = [
  ...
  'commandDeck.settings.appearance',
  'commandDeck.settings.connection',
  'commandDeck.settings.agentIntegration',
  'commandDeck.settings.agentIntegrationDescription',
  'commandDeck.settings.help',
  'commandDeck.settings.helpDescription',
  'commandDeck.settings.about',
  'commandDeck.settings.uiVersion',
  'commandDeck.settings.apiVersion',
  'commandDeck.settings.buildRevision',
