...
type EditorChromeCopy = Record<
  'catalog' | 'properties' | 'help' | 'fitView' | 'closeGuide' | 'validPlacement'
  | 'collision' | 'returnedToOrigin' | 'previousPage' | 'nextPage' | 'rotateLeft' | 'rotateRight',
  string
>;
...
} as const satisfies Record<VillageLocale, EditorChromeCopy>;
