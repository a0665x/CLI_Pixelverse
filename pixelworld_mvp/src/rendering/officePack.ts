...
export function officeFamily(item:Pick<ModernOfficeCatalogItem,'id'|'category'>):string{
 const id=item.id;
 const known:Record<number,string>={98:'plant',99:'plant',100:'plant',129:'display',170:'board',171:'board',172:'board',173:'coffee',175:'cabinet',176:'bookcase',177:'printer',180:'bookcase',193:'desk',199:'sofa',200:'sofa',1001:'bed',1002:'bookcase',1003:'plant',1004:'sofa',1005:'cabinet',1006:'chair',1007:'desk'};
