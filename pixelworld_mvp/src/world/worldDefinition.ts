...
export const WORLD_DEFINITION: WorldDefinition = {
  ...
  scenery: {
    ...
    decorations: [
      ...
      { id: 'orchard-supplies', kind: 'crate', point: { x: 14, y: 9 } },
      { id: 'plaza-north-seat-a', kind: 'bench', point: { x: 17, y: 9 } },
      { id: 'plaza-north-seat-b', kind: 'bench', point: { x: 25, y: 9 } },
      { id: 'plaza-south-sign', kind: 'signboard', point: { x: 25, y: 17 } },
      { id: 'plaza-north-flowers', kind: 'flowers', point: { x: 16, y: 8 } },
      { id: 'plaza-south-flowers', kind: 'flowers', point: { x: 25, y: 18 } },
      { id: 'river-walk-rock', kind: 'rock', point: { x: 26, y: 18 } },
      { id: 'farm-lane-crate', kind: 'crate', point: { x: 16, y: 19 } },
      { id: 'pasture-seat-a', kind: 'bench', point: { x: 39, y: 18 } },
      { id: 'pasture-seat-b', kind: 'bench', point: { x: 45, y: 18 } },
      { id: 'east-crossroad-sign-a', kind: 'signboard', point: { x: 39, y: 9 } },
      { id: 'east-crossroad-sign-b', kind: 'signboard', point: { x: 46, y: 9 } },
      { id: 'pasture-flowers-a', kind: 'flowers', point: { x: 45, y: 16 } },
      { id: 'pasture-flowers-b', kind: 'flowers', point: { x: 39, y: 19 } },
      { id: 'pasture-rock', kind: 'rock', point: { x: 46, y: 17 } },
