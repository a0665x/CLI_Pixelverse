...
export const WORLD_DEFINITION: WorldDefinition = {
  ...
  buildings: [
    {
      ...
      entrance: { outside: { x: 6, y: 7 }, threshold: { x: 6, y: 6 }, entryFacing: 'up', exitFacing: 'down' },
    },
    {
      id: 'build-workshop', label: 'Build Workshop', bounds: { x: 15, y: 2, width: 10, height: 5 }, labelAnchor: { x: 20, y: 1 },
      entrance: { outside: { x: 20, y: 7 }, threshold: { x: 20, y: 6 }, entryFacing: 'up', exitFacing: 'down' },
    },
    {
      id: 'signal-station', label: 'Collaboration & Signal Station', bounds: { x: 29, y: 2, width: 9, height: 5 }, labelAnchor: { x: 33, y: 1 },
      entrance: { outside: { x: 33, y: 7 }, threshold: { x: 33, y: 6 }, entryFacing: 'up', exitFacing: 'down' },
    },
  ],
  zones: [
  ...
  terrain: [
    { kind: 'road', bounds: { x: 1, y: 8, width: 38, height: 1 }, cost: 1 },
    { kind: 'road', bounds: { x: 6, y: 7, width: 1, height: 1 }, cost: 1 },
    { kind: 'road', bounds: { x: 20, y: 7, width: 1, height: 1 }, cost: 1 },
    { kind: 'road', bounds: { x: 33, y: 7, width: 1, height: 1 }, cost: 1 },
    { kind: 'road', bounds: { x: 11, y: 9, width: 1, height: 9 }, cost: 1 },
    { kind: 'road', bounds: { x: 20, y: 14, width: 1, height: 3 }, cost: 1 },
    { kind: 'road', bounds: { x: 32, y: 9, width: 1, height: 8 }, cost: 1 },
    { kind: 'plaza', bounds: { x: 14, y: 9, width: 12, height: 5 }, cost: 1 },
    { kind: 'grass', bounds: { x: 2, y: 10, width: 9, height: 8 }, cost: 2 },
    { kind: 'grass', bounds: { x: 14, y: 16, width: 6, height: 4 }, cost: 2 },
    { kind: 'grass', bounds: { x: 21, y: 16, width: 5, height: 4 }, cost: 2 },
    { kind: 'grass', bounds: { x: 31, y: 11, width: 1, height: 7 }, cost: 2 },
    { kind: 'grass', bounds: { x: 33, y: 11, width: 5, height: 7 }, cost: 2 },
  ],
  obstacleRects: [
    { x: 2, y: 2, width: 9, height: 4 },
    { x: 2, y: 6, width: 4, height: 1 },
    { x: 7, y: 6, width: 4, height: 1 },
    { x: 15, y: 2, width: 10, height: 4 },
    { x: 15, y: 6, width: 5, height: 1 },
    { x: 21, y: 6, width: 4, height: 1 },
    { x: 29, y: 2, width: 9, height: 4 },
    { x: 29, y: 6, width: 4, height: 1 },
    { x: 34, y: 6, width: 4, height: 1 },
  ...
  walkableOverrides: [{ x: 6, y: 6 }, { x: 20, y: 6 }, { x: 33, y: 6 }],
  stations: [
