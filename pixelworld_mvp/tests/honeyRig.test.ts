...
describe('Honey skinned Meshy asset',()=>{
 ...
 expect(bones).toBe(25);expect(skins).toBe(1);expect(triangles).toBeLessThanOrEqual(52000);expect(new T.Box3().setFromObject(scene).getSize(new T.Vector3()).y*RABBIT_SCALE).toBeLessThan(1.0);
 });
