...
export const UI_CATALOG = {
  'en-US': commandDeckCopy({
    ...
    hook: { guide: 'Hook guide', help: 'Help', semantic: { rest: 'Rest', search: 'Search', work: 'Work' }, categories: { reasoning: 'Reasoning', tool: 'Tool', subagent: 'Subagent', session: 'Session', status: 'Status', message: 'Message', completion: 'Completion' } },
    ...
    settings: { label: 'Settings', appearance: 'Appearance', connection: 'Connection', agentIntegration: 'Agent integration', agentIntegrationDescription: 'Bind the current project with hook_bridge.sh, then start the Agent to make its character live.', help: 'Help', helpDescription: 'Open setup guidance, status meanings, and troubleshooting.', about: 'About', uiVersion: 'UI version', apiVersion: 'API version', buildRevision: 'Build revision', languageSelector: 'Language selector', exposureSelector: 'Exposure selector', copyUrl: 'Copy URL' },
  ...
  'zh-TW': commandDeckCopy({
    ...
    hook: { guide: 'Hook 指南', help: '說明', semantic: { rest: '休息', search: '搜尋', work: '工作' }, categories: { reasoning: '推理', tool: '工具', subagent: '分身', session: '工作階段', status: '狀態', message: '訊息', completion: '完成' } },
    empty: { events: '尚無事件', agents: '沒有即時代理', hooks: '沒有啟用的 Hook' },
    error: { read: '讀取失敗', exposure: '公開網址更新失敗', unavailable: '無法使用' },
    settings: { label: '設定', appearance: '外觀', connection: '連線', agentIntegration: 'Agent 整合', agentIntegrationDescription: '使用 hook_bridge.sh 綁定目前專案，再啟動 Agent，角色才會上線。', help: '說明', helpDescription: '開啟安裝指引、狀態解釋與疑難排解。', about: '關於', uiVersion: 'UI 版本', apiVersion: 'API 版本', buildRevision: '建置版本', languageSelector: '語言選擇器', exposureSelector: '公開方式選擇器', copyUrl: '複製網址' },
  ...
  'ja-JP': commandDeckCopy({
    ...
    hook: { guide: 'Hook ガイド', help: 'ヘルプ', semantic: { rest: '休憩', search: '検索', work: '作業' }, categories: { reasoning: '推論', tool: 'ツール', subagent: 'サブエージェント', session: 'セッション', status: '状態', message: 'メッセージ', completion: '完了' } },
    ...
    settings: { label: '設定', appearance: '表示', connection: '接続', agentIntegration: 'エージェント連携', agentIntegrationDescription: 'hook_bridge.sh で現在のプロジェクトを連携し、エージェントを起動するとキャラクターがオンラインになります。', help: 'ヘルプ', helpDescription: 'セットアップ手順、状態の意味、トラブルシューティングを開きます。', about: 'このアプリについて', uiVersion: 'UI バージョン', apiVersion: 'API バージョン', buildRevision: 'ビルドリビジョン', languageSelector: '言語選択', exposureSelector: '公開方法の選択', copyUrl: 'URL をコピー' },
  ...
  'ko-KR': commandDeckCopy({
    ...
    hook: { guide: 'Hook 안내', help: '도움말', semantic: { rest: '휴식', search: '검색', work: '작업' }, categories: { reasoning: '추론', tool: '도구', subagent: '서브에이전트', session: '세션', status: '상태', message: '메시지', completion: '완료' } },
    ...
    settings: { label: '설정', appearance: '화면', connection: '연결', agentIntegration: '에이전트 연동', agentIntegrationDescription: 'hook_bridge.sh로 현재 프로젝트를 연결한 뒤 에이전트를 시작하면 캐릭터가 온라인 상태가 됩니다.', help: '도움말', helpDescription: '설정 안내, 상태 의미 및 문제 해결을 엽니다.', about: '정보', uiVersion: 'UI 버전', apiVersion: 'API 버전', buildRevision: '빌드 리비전', languageSelector: '언어 선택', exposureSelector: '공개 방식 선택', copyUrl: 'URL 복사' },
