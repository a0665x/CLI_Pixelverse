...
const ZH_TW = {
  ...
  brandSubtitle: '參考 Star Office 的世界優先設計，但以 Hermes 的任務、工具、分身與工作階段狀態做獨立可視化。',
  ...
  layoutDragSurfaceHint: '拖曳限制在房間內；點空白處可取消選取',
...
const EN_US = {
  brandTitle: 'Hermes Pixelverse',
  brandSubtitle: 'Inspired by Star Office world-first presentation, but rebuilt around Hermes tasks, tools, clones, and session telemetry.',
  ...
  layoutDragSurfaceHint: 'Dragging stays inside each room; click empty space to clear selection',
...
const JA_JP = {
  ...EN_US,
  brandSubtitle: 'Star Office の world-first 表現を参考にしつつ、Hermes のタスク、ツール、サブエージェント、セッション状態に合わせて再構成した可視化です。',
  ...
  layoutDragSurfaceHint: '各部屋の内側だけで移動できます。空白をクリックすると選択解除します。',
  ...
  states: { idle: '待機', thinking: '思考中', planning: '計画中', working: '実行中', blocked: 'ブロック中', self_healing: '自己修復中', awaiting_input: '入力待ち', initializing: '初期化中', sleeping: 'スリープ中', offline: 'オフライン' },
};

const KO_KR = {
  ...EN_US,
  brandSubtitle: 'Star Office의 world-first 표현을 참고하되 Hermes의 작업, 도구, 서브에이전트, 세션 상태에 맞춰 다시 설계한 시각화입니다.',
  inspectorTitle: '인스펙터',
  ...
  layoutDragSurfaceHint: '각 방 안에서만 이동할 수 있으며, 빈 공간을 클릭하면 선택이 해제됩니다.',
  ...
  states: { idle: '대기', thinking: '생각 중', planning: '계획 중', working: '작업 중', blocked: '차단됨', self_healing: '자가 복구 중', awaiting_input: '입력 대기', initializing: '초기화 중', sleeping: '절전 중', offline: '오프라인' },
};
