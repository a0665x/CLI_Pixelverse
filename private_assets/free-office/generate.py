...
for name,body in art.items():
 (p/'sprites'/f'{name}.svg').write_text(f'<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><g stroke="#56504b" stroke-width="1.6" stroke-linejoin="round" paint-order="stroke fill">{body}</g></svg>')
